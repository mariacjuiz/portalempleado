                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-info" id="to-recover" type="button"><i class="fa fa-lock m-r-5"></i>Recordar contraseña</button>
                                        <button class="btn btn-success float-right" type="submit">Iniciar sesión</button>
                                    </div>
                                    {{-- <div class="p-t-20">
                                        <button class="btn btn-warning" id="to-new" type="button"><i class="fa fa-lock m-r-5"></i>Registro</button>
                                    </div> --}}
                                </div>
                            </div>
                        </div>
